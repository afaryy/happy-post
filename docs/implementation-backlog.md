...
- [x] Replace the standard RDS design because the active Free Plan rejected seven-day retention; retain PostgreSQL 16.14, private VPC access, encrypted Aurora storage, a 0–1 ACU assessment cost guardrail, seven-day PITR target, documented windows, and final-cluster-snapshot lifecycle.
